...
const RATCHETS = [
  ...
  // Special
  "ATr",
  // Ribs — ratchet + bit integrati
  "Turbo","Operate",
];

// Ribs: ratchet con bit integrato — il campo bit non serve
...
// Fonte: beytrackr.com — ATK/DEF/STA normalizzati, bstBase derivato da DEF inverso
const RATCHET_DATA = {
  // ── 60mm ────────────────────────────────────────────────────
  "0-60": [60, 0,76, 3,14,13], "1-60": [60, 1,72,17, 9, 4],
  "2-60": [60, 2,70,16, 8, 6], "3-60": [60, 3,68,15, 9, 6],
  "4-60": [60, 4,66,11,13, 6], "5-60": [60, 5,64,12, 9, 9],
  "6-60": [60, 6,62,14, 8, 8], "7-60": [60, 7,60, 8,14, 8],
  "9-60": [60, 9,58,13,10, 7], "S6-60":[60, 6,63, 0, 2, 2],
  "F0-60":[60, 0,70, 0, 0, 0],
  // ── 65mm (UX only) ──────────────────────────────────────────
  "9-65": [65, 9,58,13,10, 7],
  // ── 70mm ────────────────────────────────────────────────────
  "0-70": [70, 0,64, 3,13,14], "1-70": [70, 1,60,17, 6, 7],
  "2-70": [70, 2,58,10,12, 8], "3-70": [70, 3,56,15, 8, 7],
  "4-70": [70, 4,54,11,12, 7], "5-70": [70, 5,52,12, 8, 9],
  "6-70": [70, 6,50,14, 7, 9], "7-70": [70, 7,48, 8,12,10],
  "9-70": [70, 9,46,13,10, 7],
  "D5-70":[70, 5,53, 0, 3, 2],
  // ── 55mm ────────────────────────────────────────────────────
  "4-55": [55, 4,70, 7,11,12],
  // ── 50mm (UX only) ──────────────────────────────────────────
  "4-50": [50, 4,72,12,13, 5],
  // ── 80mm ────────────────────────────────────────────────────
  "0-80": [80, 0,48, 3,14,13], "1-80": [80, 1,44,17, 4, 9],
  "2-80": [80, 2,42,10,11, 9], "3-80": [80, 3,40,15, 7, 8],
  "4-80": [80, 4,38,11,11, 8], "5-80": [80, 5,36,12, 8,10],
  "6-80": [80, 6,34,14, 6,10], "7-80": [80, 7,32, 7,14, 9],
  "8-70": [70, 8,47, 8,10,12], "9-80": [80, 9,30,13,10, 7],
  // ── 85mm ────────────────────────────────────────────────────
  "3-85": [85, 3,30, 5,15,10], "M-85": [85, 0,28, 8,19,13],
  // ── Special ─────────────────────────────────────────────────
  "ATr":   [70, 0,65,-3, 1, 0],
  // ── Ribs (ratchet+bit integrato) ────────────────────────────
  "Turbo":  [70, 0,62,-3, 1, 0],
  "Operate":[70, 5,60, 0, 2, 2],
};
...
const RATCHET_WEIGHTS = {
  ...
  "5-70":6.7,  "6-70":6.75, "7-70":6.9,  "8-70":7.0,  "9-70":6.8,  "D5-70":6.7,
  // 80mm
...
function calcComboStats(combo) {
  ...
  const bit   = isRib
    ? { speed:4, stamina:3, defense:3, burst:6, dash:2 }
    : BITS_MAP[combo.bit];
